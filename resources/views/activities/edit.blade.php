...
<head>
    ...
    <title>تعديل النشاط - {{ $activity->title }}</title>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white shadow-sm p-4 flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <h1 class="font-bold text-xl text-indigo-700">تعديل النشاط</h1>
            </div>
            <div class="flex items-center gap-3">
                <a href="{{ route('activities.show', $activity->id) }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-semibold">
                    <i class="fas fa-eye ml-1"></i> معاينة النشاط
                </a>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <form method="POST" action="{{ route('activities.update', $activity->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" rows="4" placeholder="اكتب وصفاً تفصيلياً..."
                                    class="input-field {{ $errors->has('description') ? 'is-invalid' : '' }}">{{ old('description', $activity->description) }}</textarea>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="time" name="end_time" value="{{ old('end_time', $activity->end_time) }}"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="url" name="online_link" value="{{ old('online_link', $activity->online_link) }}"
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="number" name="points" value="{{ old('points', $activity->points ?? 0) }}" min="0"
                            ...
                            <div class="flex items-center gap-3 mt-6">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <input type="checkbox" name="certificate" value="1"
                                        {{ old('certificate', $activity->certificate) ? 'checked' : '' }}
                                        class="sr-only peer" id="certificate_toggle">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                        ...
                        @if($activity->image)
                            <div class="mb-4 p-3 bg-gray-50 rounded-xl flex items-center gap-4">
                                <img src="{{ asset('storage/' . $activity->image) }}" class="w-20 h-20 object-cover rounded-lg">
                                <div>
                                    <p class="font-semibold text-gray-700 text-sm">الصورة الحالية</p>
                                    <p class="text-gray-400 text-xs">ارفع صورة جديدة لاستبدالها</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div x-data="imageUpload()"
                            ...
                            <template x-if="!preview">
                                <div>
                                    ...
                                    <p class="text-gray-500 font-semibold mb-1">{{ $activity->image ? 'اسحب صورة جديدة أو اضغط للاستبدال' : 'اسحب الصورة هنا أو اضغط للاختيار' }}</p>
